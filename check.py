...
while True:
    ...
    if hands and buttonPressed is False:  # If hand is detected
        ...
        #xVal = int(np.interp(lmList[8][0], [new_widths // 2, new_widths], [0, new_widths]))
        #yVal = int(np.interp(lmList[8][1], [150, new_heights-150], [0, new_heights]))  # Include entire height
