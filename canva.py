...
# Giving different arrays to handle colour points of different colour
    ...
    while ret:
        ...
        if cv2.waitKey(1) == ord('s'):
            # Get the coordinates of the white canvas area
            x, y, w, h =471,633,3 ,255  # Adjust these values according to your canvas size

            # Take a screenshot of the white canvas area
            screenshot = pyautogui.screenshot(region=(x, y, w, h))
            screenshot.save(os.path.join(save_directory, 'white_canvas_screenshot.png'))  # Save the screenshot to a file
